    ...
    <div className=" h-auto" id="header-div">
      <div className="flex flex-row flex-wrap gap-[6rem] max-sm:gap-[2rem] max-md:gap-[3rem] justify-center items-center pt-[1rem] bg-[#f5db87] h-[34rem] mb-[4.5rem] text-center max-sm:text-center">
        <img
          ...
          alt=""
          class="w-[400px] h-[350px] ml-[2rem] right-[1rem] relative max-xl:w-[300px] max-xl:h-[250px] max-lg:w-[250px] max-lg:h-[220px] max-lg:top-[0rem] max-md:top-[0rem] max-md:w-[180px] max-md:h-[150px] max-sm:ml-[5rem] max-sm:right-[1.7rem] max-sm:w-[200px] max-sm:h-[180px] max-sm:top-[1rem]"
          id="pastel-main"
        />
